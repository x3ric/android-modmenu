...
void Init(JNIEnv *env, jobject thiz, jobject ctx, jobject title, jobject subtitle){
    //Set sub title
    setText(env, title, OBFUSCATE("<b>Mod Menu</b>"));

    //Set sub title
    setText(env, subtitle, OBFUSCATE("<b><marquee><p style=\"font-size:30\">"
                                     "<p style=\"color:#C880FF;\">Modded by x3ric</p> | "
                                     "https://github.com/x3ric | "
                                     "<p style=\"color:#C880FF;\">Hacking for fun</p>"
                                     "</marquee></b>"));
    ...
    //Toast Example
    Toast(env,ctx,OBFUSCATE("Modded by x3ric"),ToastLength::LENGTH_LONG);
