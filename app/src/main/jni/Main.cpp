...
jobjectArray GetFeatureList(JNIEnv *env, jobject context) {
    ...
    const char *features[] = {
            ...
            OBFUSCATE("RichTextView_This is text view, not fully HTML."
                      ...
                      "<br />New line <font color='gray'>Support colors</font>"
                      "<br/><big>bigger Text</big>"),
            OBFUSCATE("RichWebView_<html><head><style>body{color: white;}</style></head><body>"
                      "This is WebView, with REAL HTML support!"
                      "<div style=\"background-color: white; color: black; text-align: center;\">Support CSS</div>"
                      "<marquee style=\"color: gray; font-weight:bold;\" direction=\"left\" scrollamount=\"5\" behavior=\"scroll\">This is <u>scrollable</u> text</marquee>"
                      "</body></html>")
    };
