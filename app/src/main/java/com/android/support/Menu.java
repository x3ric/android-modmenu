...
public class Menu {
    ...
    int TEXT_COLOR = Color.parseColor("#A382FD");
    int TEXT_COLOR_2 = Color.parseColor("#FFFFFF");
    int BTN_COLOR = Color.parseColor("#0a0a0a");
    int MENU_BG_COLOR = Color.parseColor("#EE000000"); //#AARRGGBB
    int MENU_FEATURE_BG_COLOR = Color.parseColor("#DD070707"); //#AARRGGBB
    int MENU_WIDTH = 290;
    int MENU_HEIGHT = 210;
    int POS_X = 0;
    int POS_Y = 100;
    ...
    int BtnON = Color.parseColor("#9900FF");
    int BtnOFF = Color.parseColor("#481577");
    int ToggleON = BtnON;
    int ToggleOFF = BtnOFF;
    int CategoryBG = Color.parseColor("#050505");
    int SeekBarColor = Color.parseColor("#AD80CB");
    int SeekBarProgressColor = Color.parseColor("#AD80CB");
    int CheckBoxColor = Color.parseColor("#AD80CB");
    int RadioColor = Color.parseColor("#FFFFFF");
    String NumberTxtColor = "#9232FF";
    //********************************************************************//
    ...
    public static void StartMenu(Context context) {
        if (Build.VERSION.SDK_INT >= 23) { //Android 6.0
            Main.StartWithoutPermission(context);
        } else  {
            Main.Start(context);
        }
    }
    ...
    public Menu(Context context) {
        ...
        gdMenuBody.setStroke(1, Color.parseColor("#7A00CB")); //Set border
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if (Preferences.loadPref && !IsGameLibLoaded() && !stopChecking) {
                    ...
                    mods.removeAllViews();
                    featureList(GetFeatureList(), mods); // Showed Items
                }
            }
        }, 500);
    }
    ...
    private void Collapse(LinearLayout linLayout, final String text, final boolean expanded) {
        ...
        collapseSub.setBackgroundColor(Color.parseColor("#080808"));
